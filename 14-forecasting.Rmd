...
```{r futures, echo=FALSE, fig.cap='Simulated futures of a forecast'}
include_graphics('_bookdown_files/forecast_futures.png')
```

```{r ci, echo=FALSE, fig.cap='Confidence intervals based on simultated futures'}
include_graphics('_bookdown_files/forecast_ci.png')
```
...
```{r fcompare, echo=FALSE, fig.cap='Comparison of forecast models to trend data'}
autoplot(gdp_meanf) +
  theme_minimal() +
  labs(y = "GDP")
