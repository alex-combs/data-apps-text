...
This resource presents examples and exercises using R. Students who intend to use a personal computer must download and install the following software:
...
There are numerous free materials that teach statistics and R. Below is a list of books and websites that offer broader and deeper treatments of some concepts and skills covered in this resource.
