...
library(fpp2)
countyComplete <- fread('https://www.openintro.org/data/R/county_complete.R')
```
...
```{block, type='learncheck', purl=FALSE}
**Exercise 2:**  Generate a simple, default box plot for `bachelors_2010` (no optional code unless you want to add it).
```
