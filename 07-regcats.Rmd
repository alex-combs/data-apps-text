...
First, let's visualize the relationship between these variables using a scatter plot with `vmiles` on the x axis and using color to differentiate states with and with and without mandatory jail sentences for drunk driving. Note in Figure \@ref(fig:pslopescatter) below there appears to be a positive relationship between the average miles people drive and the traffic fatalities. That makes sense.
...
and if a state does have a madatory jail sentence, then we have
