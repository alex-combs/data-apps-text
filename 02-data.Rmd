...
include_graphics("docs/_bookdown_files/variables.png")
```
</center>
<br>
...
- **Qualitative** variables take on values that have no intrensic numerical meaning. They are exressed in words.
- **Quantitative** variables take on values that do have intrensic numerical meaning.
...
**Time series** data measures one unit over mulitple time periods. The unit of analysis in time series data is time, as it uniquely identifies each row. Notice in Table 2.4 that one country is tracked over multiple years.
...
- Chapter 1 of OpenIntro Statistics